...
class Net(nn.Module):
    def __init__(self, batch_normalization=False):
        ...
        for i in range(N_HIDDEN):               # build hidden layers and BN layers
            ...
            fc = nn.Linear(input_size, 10)      # Applies a linear transformation to the incoming data: y=Ax+b
...
# you can have to nets in one single architecture

# print(*nets)    # print net architecture

opts = [torch.optim.Adam(net.parameters(), lr=LR) for net in nets]  # one optimizer for two nets
# print (opts)
# print (*opts)
