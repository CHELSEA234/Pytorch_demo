...
def restore_params():
    ...
    net1.load_state_dict(state_dict=torch.load('net_params.pkl'))
    # net = torch.load('net.pkl') you can't just load parameters here
    # net1.load_state_dict(net.parameters)
    prediction = net1(x)
