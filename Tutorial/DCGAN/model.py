...
class Discriminator(nn.Module):
    ...
    def __init__(self, image_size=128, conv_dim=64):
        ...
        self.conv1 = conv(3, conv_dim, 4, bn=False)		# 3 dim is RGB, out is 64, k_size is 4
        self.conv2 = conv(conv_dim, conv_dim*2, 4)		# 64 dim is in, out is 128, k_size is 4
        self.conv3 = conv(conv_dim*2, conv_dim*4, 4)		# 128 dim is in, out is 256, k_size is 4
        self.conv4 = conv(conv_dim*4, conv_dim*8, 4)		# 256 dim is in, out is 512
        self.fc = conv(conv_dim*8, 1, int(image_size/16), 1, 0, False)		# 512 dim is in, out is 1, k_size is 8
...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim=256, image_size=128, conv_dim=64):
        ...
        self.fc = deconv(z_dim, conv_dim*8, int(image_size/16), 1, 0, bn=False)		# input_dim is 256, 
